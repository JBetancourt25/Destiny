...
//TODO: Step 7 - Uncomment the lines below to include storyData as a private property in StoryBrain. Hint: You might need to change something in story.dart to make this work.
  ...
  getStory() {
    return _storyData[numberStory].storyTitle;
  }

  getChoice1() {
    return _storyData[numberStory].choice1;
  }

  getChoice2() {
    return _storyData[numberStory].choice2;
  }
...
//TODO: Step 17 - Create a method called nextStory(), it should not have any outputs but it should have 1 input called choiceNumber which will be the choice number (int) made by the user.
  nextStory(int choiceNumber) {
    if (choiceNumber == 1 && numberStory == 0) {
      numberStory = 2;
    } else if (choiceNumber == 2 && numberStory == 0) {
      numberStory = 1;
    } else if (choiceNumber == 1 && numberStory == 1) {
      numberStory = 2;
    } else if (choiceNumber == 2 && numberStory == 1) {
      numberStory = 3;
    } else if (choiceNumber == 1 && numberStory == 2) {
      numberStory = 5;
    } else if (choiceNumber == 2 && numberStory == 2) {
      numberStory = 4;
    } else if (numberStory == 3 || numberStory == 4 || numberStory == 5) {
      restart();
    }
  }
